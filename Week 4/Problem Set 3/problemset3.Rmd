...
Answer: *Reading scores, on average, are about 3.5 percentage points higher for students assigned to smaller classes than for students assigned to regular classes.*
...
2.6. Describe how the differences in mean performance (the values calculated in 2.1 and 2.2) compare to the standard deviations in performance for reading and math tests. What does this comparison suggest about the effect of small class sizes on test performance?
