...
1. We use the *cor()* function to compute correlations in R.  cor() will return a signed coefficient.

Compute the correlation between republican.therm and democrat.therm for everyone, for Democrats and for Republicans.
...
1.1. How many villages were hit by Russian fire?  Note that villages will appear multiple times (one record for each time the Russians fired).
```{r}
