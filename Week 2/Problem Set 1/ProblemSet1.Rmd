...
### Question 1
1.1. How many precincts are there in the data set (ignore multiple entries)? 
```{r}
...
3.3. Compute the percentage of Trump votes that were cast in advance of election day and save this to a new column called `percentTrumpAdvance`.  Do the same for Biden to create a `percentBidenAdvance`.  In how many precincts was advance turnout larger for Biden than Trump?
...
4.5. Repeat 4.3, but only remove absentee voters from Biden's total.  In how many precincts did Biden win?
```{r}
