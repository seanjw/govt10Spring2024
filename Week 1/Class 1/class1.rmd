...
R Markdown Notebooks allow us to write text, write code and generate results within a single file.  In this class all in-class assignments and problem sets will be submitted using Markdown Notebooks to generate PDF files.  
